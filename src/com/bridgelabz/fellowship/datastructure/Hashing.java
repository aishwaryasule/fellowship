...
public class Hashing
{
	...
	public void write() throws Exception 
	{
		try 
		{
		PrintStream o = new PrintStream(new File("/home/admin1/Desktop/FellowshipProgramsJavaAishwarya/fellowship programs/src/com/bridgelabz/fellowshipprogram/utility/Myfile.txt"));
		System.setOut(o);
		for(int i=0;i<table.length;i++) 
		{
			System.out.print(i+"");
